...
var LoadMask = ReactLoadMask;
var Region = region;

var PaginationToolbar = React.createFactory(DataGridPaginationToolbar);
var Column = DataGridColumn;

var PropTypes      = DataGridPropTypes;
var Wrapper        = DataGridWrapper;
var Header         = DataGridHeader;
var WrapperFactory = React.createFactory(Wrapper);
var HeaderFactory  = React.createFactory(Header);

var ResizeProxy     = DataGridResizeProxy;
...
DataGrid = React.createClass({
  ...
  getDefaultProps: DataGridGetDefaultProps,
  ...
  getTableProps: function(props, state){
    ...
    table = getTableProps(props, rows);
  ...
  prepareLoading: function prepareLoading(props) {
    var showLoadMask = props.showLoadMask;
  ...
  isRemoteDataSource: function isRemoteDataSource(props) {
    ...
    return props.dataSource && !_.isArray(props.dataSource);
  },
  ...
  prepareColumnStyle: function prepareColumnStyle(props, column) {
    ...
    column.style = _.extend({}, column.style);
  ...
  prepareResizeProxy: function prepareResizeProxy(props, state) {
    return <DataGridResizeProxy ref="resizeProxy" active={state.resizing}/>;
  },
