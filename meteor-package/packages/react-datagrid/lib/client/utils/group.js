...
copyIf = function copyIf(source, target){
  var hasOwn = _.has(target);
...
groupByFields = function groupByFields(data, fields, path, names, fieldIndex){
  data       = data       || [];
...
groupArrayByField = function groupArrayByField(data, field){
