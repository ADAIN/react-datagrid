 ...
 * 날짜 : 2015. 12. 27.
 * 내용 : DataGridPaginationToolbar component react class
 */
...
function separator(props){
  ...
  var style = ReactStyleNormalizer({
...
DataGridPaginationToolbar = React.createClass({
  ...
  prepareIconProps: function(props) {
    var iconProps = _.extend({}, props.defaultIconProps);
    ...
    _.extend(iconProps, props.iconProps);
    ...
    iconProps.style = _.extend({}, defaultIconStyle, iconSizeStyle, iconProps.style);
    iconProps.overStyle = _.extend({}, defaultIconOverStyle, iconProps.overStyle);
    iconProps.disabledStyle = _.extend({}, defaultIconDisabledStyle, iconProps.disabledStyle);
  ...
  prepareStyle: function(props) {
    ...
    return _.extend({}, props.defaultStyle, borderStyle, props.style);
  },
  ...
  render: function(){
    ...
    return <ReactSimpleToolbar {...props}>
      <ReactSimpleToolbarRegion flex="1 1 auto" style={ReactStyleNormalizer({display: 'flex', alignItems: 'center', minWidth: minWidth})}>
        ...
        {pageSize}
      </ReactSimpleToolbarRegion>
      <ReactSimpleToolbarRegion  flex="1 1 auto">
        {displaying}
      </ReactSimpleToolbarRegion>
    </ReactSimpleToolbar>;
  },
  ...
  icon: function(iconName, props) {
    ...
    if (!icon || typeof icon != 'function'){
      ...
      var iconProps = _.extend({
        mouseOver: mouseOver,
        name    : iconName,
        disabled: disabled
      }, props.iconProps);

      var iconStyle = iconProps.style = _.extend({}, iconProps.style, defaultStyles[iconName], props.iconStyle, props[iconName + 'IconStyle']);

      if (mouseOver){
        iconProps.style = _.extend({}, iconStyle, iconProps.overStyle, props.overIconStyle);
      }
      if (disabled){
        iconProps.style = _.extend({}, iconStyle, iconProps.disabledStyle, props.disabledIconStyle);
      } else {
