 ...
 * 날짜 : 2015. 12. 27.
 * 내용 : getGroupedRows component react class
 */

var CellFactory = React.createFactory(DataGridCell);
...
function renderGroupRow(props, groupData){
  ...
  return <DataGridRow className='z-group-row' key={'group-'+groupData.valuePath} rowHeight={props.rowHeight}>
    <Cell
...
getGroupedRows = function(props, groupData){
