 ...
 * 날짜 : 2015. 12. 29.
 * 내용 : ReactVirtualScroller component react class
 * URL : https://github.com/zippyui/react-virtual-scroller
 */
 ...
 */
var syncScrollbar = function(orientation) {
...
var scrollAt = function(orientation){
...
var reactVirtualScrollerSelf = null;
var onScroll = function onScroll(orientation){
  ...
  return function(event){
    ...
    var onScroll   = reactVirtualScrollerSelf[ON_SCROLL_NAMES[orientation]];
    var onOverflow = reactVirtualScrollerSelf[ON_OVERFLOW_NAMES[orientation]];
...
ReactVirtualScroller = React.createClass({
  render(){
    reactVirtualScrollerSelf = this;
...
_.extend(ReactVirtualScroller.prototype, {
...
ReactVirtualScroller.propTypes = {
...
ReactVirtualScroller.defaultProps = {
