 ...
 * 날짜 : 2015. 12. 28.
 * 내용 : ReactMenusGetSubMenuPositionStyle component react class
 */

var Region = region;
var align  = ReactMenusAlign;

var findDOMNode = ReactDOM.findDOMNode;

ReactMenusGetSubMenuPositionStyle = function (props, state){
  ...
  if (sameMenu || (this.aligning && this.alignOffset)){
    _.extend(style, this.alignOffset);
