 ...
 * 날짜 : 2015. 12. 28.
 * 내용 : ReactMenusScrollContainer component react class
 */

var buffer = Buffer;
var findDOMNode = ReactDOM.findDOMNode;

var Scroller = ReactMenusScroller;
...
ReactMenusScrollContainer = React.createClass({
  ...
  render: function(){
    ...
    >
      <div ref="tableWrap" style={scrollStyle}>
        {children}
      </div>
  ...
  renderScroller: function(props, direction) {
    ...
    var scrollerProps = _.extend({}, props.scrollerProps, {
      visible    : visible,
