 ...
 * 날짜 : 2015. 12. 28.
 * 내용 : ReactMenusScroller component react class
 */

var getArrowStyle = arrowStyle;
...
function generateArrowStyle(props, state, overrideStyle){
  ...
  _.extend(style, getArrowStyle(props.side == 'top'? 'up':'down', arrowConfig));
...
ReactMenusScroller = React.createClass({
  ...
  prepareStyle: function(props, state) {
    ...
    var style = _.extend({}, SCROLLER_STYLE,
  ...
  prepareArrowStyle: function(props, state) {
    ...
    var arrowStyle = _.extend({}, props.defaultArrowStyle, defaultArrowOverStyle, props.arrowStyle, arrowOverStyle);
