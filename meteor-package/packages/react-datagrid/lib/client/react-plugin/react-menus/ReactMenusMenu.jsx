 ...
 * 날짜 : 2015. 12. 28.
 * 내용 : ReactMenusMenu component react class
 */

var Region = region;
var inTriangle = pointInTriangle;
...
var getItemStyleProps   = ReactMenusGetItemStyleProps;
var renderSubMenu       = ReactMenusRenderSubMenu;
var renderChildren      = ReactMenusRenderChildren;
var prepareItem         = ReactMenusPrepareItem;

var propTypes = ReactMenusPropTypes;
var ScrollContainer = ReactMenusScrollContainer;

var findDOMNode = ReactDOM.findDOMNode;

ReactMenusMenu = React.createClass({
  displayName: 'Menu',
  ...
  prepareScrollerProps: function(props) {
    return _.extend({}, props.scrollerProps);
  },
  ...
  prepareStyle: function(props, state) {
    ...
    var style = _.extend({}, props.defaultStyle, subMenuStyle, props.style, props.subMenuStyle);
    ...
    if (props.at){
      ...
      _.extend(style, coords);
    }

    if (state.style){
      _.extend(style, state.style);
    }
