 ...
 * 날짜 : 2015. 12. 28.
 * 내용 : npm plugin region
 * URL : https://github.com/radubrehar/region
 */
...
region = function(top, right, bottom, left) {
  if (!(this instanceof resion)){
    return newify(resion, arguments);
  }
